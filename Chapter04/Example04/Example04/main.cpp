/*********************************************************************************
程序描述: Direct3D 中的 2D 编程, 范例 4.4 之 VC++ 2008 版
程序作者: Ernest Pazera
程序功能: 简单演示三角形图元的使用
附加依赖: d3d9.lib
创建日期: 2013/01/01
...
// window title
const wchar_t* WINDOW_TITLE = L"Example 4.4 (TGO-04-D): Drawing Triangles without a Vertex Buffer";
// screen width and height
const int SCREEN_WIDTH  = 800;
const int SCREEN_HEIGHT = 600;
// vertex and primitive counts
const int VERTEX_COUNT    = 3;
const int PRIMITIVE_COUNT = 1;
// pi
...
void RedrawFrame()
{
	...
	g_pd3ddev->DrawPrimitiveUP(D3DPT_TRIANGLELIST, PRIMITIVE_COUNT, g_vertices, sizeof(CustomVertex));
