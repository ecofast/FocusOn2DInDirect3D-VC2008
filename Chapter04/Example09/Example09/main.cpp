/*********************************************************************************
程序描述: Direct3D 中的 2D 编程, 范例 4.9 之 VC++ 2008 版
程序作者: Ernest Pazera
程序功能: 简单演示三角形图元的使用
附加依赖: d3d9.lib
创建日期: 2013/01/01
...
// window title
const wchar_t* WINDOW_TITLE = L"Example 4.9";
...
void Setup()
{
	...
	g_vertices[11].diffuse = D3DCOLOR_XRGB(0, 255, 0);
...
void RedrawFrame()
{
	...
	// vertex 11
	g_vertices[11].x = SCREEN_WIDTH / 2 + cos(g_angle) * RADIUS;
	g_vertices[11].y = SCREEN_HEIGHT / 2 + sin(g_angle) * RADIUS;
	...
	g_pd3ddev->DrawPrimitive(D3DPT_TRIANGLEFAN, 0, PRIMITIVE_COUNT);
