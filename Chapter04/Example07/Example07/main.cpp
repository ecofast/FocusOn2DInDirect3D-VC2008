/*********************************************************************************
程序描述: Direct3D 中的 2D 编程, 范例 4.7 之 VC++ 2008 版
程序作者: Ernest Pazera
程序功能: 简单演示线图元的使用
附加依赖: d3d9.lib
创建日期: 2013/01/01
...
// window title
const wchar_t* WINDOW_TITLE = L"Example 4.7 (TGO-04-E): Drawing Indexed Lines without a Vertex Buffer or Index Buffer";
...
void Setup()
{
	...
	// line 3 from vertex 2 to vertex 0
	g_indices[4] = 2;
	g_indices[5] = 0;
...
void RedrawFrame()
{
	...
	g_pd3ddev->DrawIndexedPrimitiveUP(D3DPT_LINELIST, 0, VERTEX_COUNT, PRIMITIVE_COUNT, g_indices, D3DFMT_INDEX16, g_vertices, sizeof(CustomVertex));
