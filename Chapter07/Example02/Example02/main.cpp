/*******************************************************************
程序描述: Direct3D 中的 2D 编程, 范例 7.2 之 VC++ 2008 版
程序作者: Ernest Pazera
程序功能: Alpha Test 演示
附加依赖: d3d9.lib
创建日期: 2012/01/08
...
#include "SpriteSet.h"     // include sprite stuff
...
// window title
const wchar_t* WINDOW_TITLE = L"Example 7.2 (TGO-07-C): Multitexturing";
...
{	
	...
	// set FVF
	g_pd3ddev->SetFVF(SPRITESET_VERTEX_FVF);
	...
	// create sprite set
	g_pSpriteSet = new CSpriteSet(g_pd3ddev, L"sprites.bmp", D3DFMT_A1R5G5B5);
...
void RedrawFrame()
{
	...
	// render a sprite
	g_pSpriteSet->PutSprite(g_image, g_x, g_y, g_angle, g_scalex, g_scaley);
