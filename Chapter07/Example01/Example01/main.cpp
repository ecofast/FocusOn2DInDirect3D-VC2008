/*******************************************************************
程序描述: Direct3D 中的 2D 编程, 范例 7.1 之 VC++ 2008 版
程序作者: Ernest Pazera
程序功能: Alpha Test 演示
附加依赖: d3d9.lib
创建日期: 2012/01/08
...
#include "d3dicon.h"       // include alpha test texture loading
...
// window title
const wchar_t* WINDOW_TITLE = L"Example 7.1 (TGO-07-B): Alpha Testing";
...
void Setup()
{
	...
	// load texture
	g_pTexture = LoadIconTexture(g_pd3ddev, L"north.bmp", D3DFMT_A1R5G5B5);
	...
	g_vertices[1].diffuse = D3DCOLOR_XRGB(255, 255, 255);
	g_vertices[2].diffuse = D3DCOLOR_XRGB(255, 255, 255);
...
{
	// clear the screen
	g_pd3ddev->Clear(0, NULL, D3DCLEAR_TARGET, D3DCOLOR_XRGB(255, 255, 0), 0.0f, 0);
