/*******************************************************************
程序描述: Direct3D 中的 2D 编程, 范例 6.3 之 VC++ 2008 版
程序作者: Ernest Pazera
程序功能: 纹理环绕模式示例
附加依赖: d3d9.lib
创建日期: 2012/01/07
...
// window title
const wchar_t* WINDOW_TITLE = L"Example 6.3 (TGO-06-E): Texture Wrapping(mirrored)";
...
void Setup()
{
	...
	// set texture stage states to mirrored
